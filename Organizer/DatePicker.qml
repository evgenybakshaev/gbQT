                    ...
                    Button {
                        ...
                        style: ButtonStyle {
                            background: Rectangle {
                                 ...
                                 */
                                Image {
                                    source: control.pressed ? "qrc:///img/left_arrow_disable.png" : "qrc:///img/left_arrow.png"
                                    width: parent.height - 8
                                    height: width
                                }
                            }
                    ...
                    Button {
                        ...
                        style: ButtonStyle {
                            ...
                            background: Rectangle {
                                 ...
                                 */
                                Image {
                                    source: control.pressed ? "qrc:///img/right_arrow_disable.png" : "qrc:///img/right_arrow.png"
                                    width: parent.height - 8
                                    height: width
                                }
                            }
